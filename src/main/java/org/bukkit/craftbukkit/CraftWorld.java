...
public class CraftWorld implements World {
    ...
    public net.minecraft.entity.Entity createEntity(Location location, Class<? extends Entity> clazz) throws IllegalArgumentException {
        ...
        if (Boat.class.isAssignableFrom(clazz)) {
            ...
            entity = new EntityXPOrb(world, x, y, z, 0, ExperienceOrb.SpawnReason.UNKNOWN, null);
    ...
    public void playSound(Location loc, String sound, org.bukkit.SoundCategory category, float volume, float pitch) {
        ...
        world.getMinecraftServer().getPlayerList().sendToAllNearExcept(null, x, y, z, volume > 1.0F ? 16.0F * volume : 16.0D, this.world.dimension, packet);  // Paper - this.world.dimension -> this.world
    }
