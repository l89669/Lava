...
public class LavaRegistryNamespaced extends RegistryNamespaced<ResourceLocation, Class<? extends Entity>> implements IObjectIntIterable<Class<? extends Entity>> {
    @Override
