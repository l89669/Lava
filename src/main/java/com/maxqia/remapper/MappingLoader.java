...
public class MappingLoader {
    ...
    private static void loadNmsMappings(JarMapping jarMapping) throws IOException {
        ...
        relocations.put("net.minecraft.server", "net.minecraft.server." + RemapUtils.NMS_VERSION);

        jarMapping.loadMappings(
                new BufferedReader(new InputStreamReader(MappingLoader.class.getClassLoader().getResourceAsStream("mappings/NMSMappings.srg"))),
